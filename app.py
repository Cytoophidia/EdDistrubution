...
g = random.randint(80, 256)
b = random.randint(80, 256)

st.set_page_config(layout="wide")


schoolData = pd.read_csv('data/Most-Recent-Cohorts-Institution.csv')
...
year = st.sidebar.selectbox(
    "Filter the year after enrollment?",
    options=(6,8,10)
)
# df_selection = df_selection.query(
#     "CITY == @city"
...
# Public School
st.subheader("Public School Cost: " + city + " city VS " + state + " state")
df_pub = pd.DataFrame()
...
# Private School
st.subheader("Private School Cost: " + city + " city VS " + state + " state")
